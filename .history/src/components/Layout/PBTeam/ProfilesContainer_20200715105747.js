...
const ProfilesContainer = () => {
    return (
        <div className='ProfilesContainer'>
            ...
            <Profile name='Henrika Lim' role='Co-founder' headshot={Henrika} linkedin='https://www.linkedin.com/in/daviddzhou/'/>
            <Profile name='Milap Patel' role='Co-founder' headshot={Milap} linkedin='https://www.linkedin.com/in/henrikalim/'/>
