...
const ProfilesContainer = () => {
    return (
        <div className='ProfilesContainer'>
            ...
            <Profile name='Joseph Shin' role='Director of Growth and Marketing' headshot={Joseph} linkedin='https://www.linkedin.com/in/henrikalim/'/>
            <Profile name='Darsh Thakkar' role='Director of Product Studies' headshot={Darsh} linkedin='https://www.linkedin.com/in/henrikalim/'/>
            <Profile name='Randy Shao' role='Web Developer' headshot={Randy} linkedin='https://www.linkedin.com/in/henrikalim/'/>
            <Profile name='Sarah Ahmed' role='Web Developer' headshot={Sarah} linkedin='https://www.linkedin.com/in/henrikalim/'/>
            <Profile name='Phyllis Njoroge' role='Creative Director' headshot={Phyllis} linkedin='https://www.linkedin.com/in/henrikalim/'/>
            <Profile name='Benjamin Allan-Rahill' role='Designer' headshot={Ben} linkedin='https://www.linkedin.com/in/henrikalim/'/>
            <Profile name='Linh Tran' role='Editor' headshot={Linh} linkedin='https://www.linkedin.com/in/henrikalim/'/>
        </div>
    )
}
