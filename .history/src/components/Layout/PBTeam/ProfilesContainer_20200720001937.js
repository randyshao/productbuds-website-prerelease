    ...
    return (
        <Auxiliary>
            ...
            <div className='ProfilesContainer'>
                {teamMember.map(image => {
                    return <img key={image.headshot} src={require(`../../../assets/images/team/${image.headshot}.jpg`)} />
                })};
