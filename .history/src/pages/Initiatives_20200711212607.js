...
const Initiatives = () => {
    return (
        <Auxiliary>
            ...
            <Initiative title='Project Jam'>From joining the Product Buds Book Club, we hope you will learn more about topics related but not limited to Product Management,
