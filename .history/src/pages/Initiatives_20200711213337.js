...
const Initiatives = () => {
    return (
        <Auxiliary>
            ...
            <Initiative title='Project Jam' class='LeftAlign'>The Product Buds Project Jam enables you to work on collaborative projects, immerse you in the product development process, 
            ...
            <Initiative title='Book Club' class='RightAlign'>From joining the Product Buds Book Club, we hope you will learn more about topics related but not limited to Product Management,
