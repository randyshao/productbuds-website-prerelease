...
import InitiativeLeft from '../components/Layout/ImageTextBox/Initiative/InitiativeLeft'
...
const Initiatives = () => {
    return (
        <Auxiliary>
            ...
            <InitiativeLeft title='Project Jam'>The Product Buds Project Jam enables you to work on collaborative projects, immerse you in the product development process, 
            ...
            <InitiativeLEft title='Book Club'>From joining the Product Buds Book Club, we hope you will learn more about topics related but not limited to Product Management,
                ...
                discussion sessions among book club members via Zoom. </InitiativeLeft>
        </Auxiliary>
    )
}
