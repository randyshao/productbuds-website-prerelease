...
const Initiatives = () => {
    return (
        <Auxiliary>
            ...
            <Initiative title='Product Case Studies'>Solving product case studies cultivates Product Sense, a skill that is heavily tested and leveraged in PM interviews and 
