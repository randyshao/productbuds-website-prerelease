...
const ProfilesContainer = () => {
  const teamMember = [
    ...
    },
    {
      ...
      bio:
        "Randy Shao is a third year at Queen's University studying Computer Science. As an aspiring Product Manager, he is fascinated on how to build tech products with a more user-driven mindset in order to better understand and empathize with the user on how he can make their lives easier through technology. Currently, he is working at a small tech startup as a technology and marketing intern. Outside of tech, he is really passionate about photography, videography and travelling.",
    },
    {
      name: 'Sarah Ahmed',
      role: 'UX Designer',
      headshot: Sarah,
      linkedin: 'https://www.linkedin.com/in/sarahahmed31415/',
      bio:
