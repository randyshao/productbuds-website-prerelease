  ...
  return (
    ...
    >
        ...
        <SwiperSlide>
            <div className='QuoteBox'>
                <img src={Janine}/>
                <p className='QuotePadding'>Prior to joining PB, I've only heard of PM through colleagues and friends, but I didn't exactly knew if this field is something I can potentially embark a career on. Hence, I joined PB with the intention of simply yearning to learn from individuals across diverse industries. I'm a huge advocate of applying theory to practice. In fact, I was able to prototype my first product after attending all PB events and networking with other PB members. Truly grateful, and I look forward to sprouting, growing, and flourishing! </p>
                <h3>Janine Co, Product and Content Strategist @ OneClass</h3>
            </div>
        </SwiperSlide>
        <SwiperSlide>
            <div className='QuoteBox'>
